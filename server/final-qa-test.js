...
async function run(){
 ...
 const uiFiles=["../index.html","../admin.html","../staff.html","../chef.html"].map(file=>fs.readFileSync(path.join(__dirname,file),"utf8"));ok(uiFiles.every(html=>html.includes("ui.js")&&html.includes("ui.css")),"Theme layer missing from a major page");
